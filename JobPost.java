...
public class JobPost {
 public static void main(String[] args) {
     ...
     //file part
     try (PrintWriter writer = new PrintWriter(new FileWriter("job_post.txt", true))) {
         writer.println("Company Name: " + companyName);
         writer.println("Position: " + position);
         writer.println("Subject Field: " + subjectField);
         writer.println("Education Level: " + educationLevel);
         writer.println("Required CGPA (4.00 Scale): " + cgpa);
         writer.println("Job Description: " + jobDescription);
         writer.println("Salary: " + salary);
         writer.println("Location: " + location);
         writer.println("Job Type: " + jobType);
